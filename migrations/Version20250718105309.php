 ...
 */
final class Version20250718105309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, amount_cents INT NOT NULL, state VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_6D28840D7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
